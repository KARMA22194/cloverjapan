...
export const metadata: Metadata = { title: "Reiseablauf – Clover Japan" };
...
export default async function AblaufPage() {
  ...
  return (
    <div className="max-w-2xl">
      <h1 className="mb-1 text-xl text-slate-900 dark:text-slate-100">Reiseablauf · Japan</h1>
      <p className="mb-4 text-sm text-slate-500 dark:text-slate-400">
        Flüge, Orte und Aufgaben – Tag für Tag zusammengeführt.
      </p>
